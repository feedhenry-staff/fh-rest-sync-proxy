...
module.exports = function(dataset, opts) {
   ...
   * @param  {Function} callback
   */
  ret.handleList = function handleList(dataset, params, meta_data, callback) {
    log.debug(
   ...
   * @param  {Function} callback
   */
  ret.handleRead = function handleRead(dataset, id, meta_data, callback) {
    log.debug(
   ...
   * @param  {Function} callback
   */
  ret.handleUpdate = function handleUpdate(
    dataset,
    id,
    data,
    meta_data,
   ...
   * @param  {Function} callback
   */
  ret.handleDelete = function handleDelete(dataset, id, meta_data, callback) {
    log.debug(
      'performing "%s" for dataset "%s" for id "%s"',
      'handleDelete',
      dataset,
   ...
   * @param  {Function} callback
   */
  ret.handleCreate = function(dataset, data, meta_data, callback) {
    log.debug(
      'performing "%s" for dataset "%s" with data %j',
      'handleCreate',
      dataset,
